# #!/bin/bash
#  python experiments.py 'official_base#augmented_noisy_random_seq2seq#seq2seq_noisy#soft(lstm_ar)' | tee output/official_base#augmented_noisy_random_seq2seq#seq2seq_noisy#soft\(lstm_ar\).txt
# run(){
#     echo $1
